    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="/create/ranger.html" id="createDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Create
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <div class="row">
            <div class="col-md-4">
                        ...
                        <div class="entries">
                            ...
                            <a href="/IGMMS/wildlifetrackereverse/sightings/one.php"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
                        ...
                        <div class="entries">
                            ...
                            <a href="/sightings/two.html"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/2"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                    
                        <div class="entries">
                            <p class="text" id="3">fatah</p><br>
                            <a href="/sightings/three.html"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/3"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/sightings/four.html"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/4"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/5"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/5"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/6"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/6"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/7"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/7"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/8"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/8"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/9"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/9"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/10"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/10"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/11"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/11"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/12"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/12"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/13"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/13"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/14"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/14"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/15"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/15"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/16"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/16"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href="/view/ranger/sightings/17"><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/17"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href=""><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/18"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
                        ...
                        <div class="entries">
                            ...
                            <a href=""><button class="btn btn-primary btn-md">View
                                Sightings</button></a>
<!--                            <a href="/view/ranger/delete/19"><button class="btn btn-danger-->
<!--                            btn-md">Delete Ranger</button></a>-->
                        </div>
                        <hr><br>
