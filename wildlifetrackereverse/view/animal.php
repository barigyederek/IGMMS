...
<body data-new-gr-c-s-check-loaded="14.1026.0" data-gr-ext-installed="">
    ...
    <div class="main-content">
        ...
        <div class="views animals">
                    ...
                    <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Albino Giraffe</h5>
                            <p class="card-text">endangered</p>
                    ...
                    <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">African Golden Cat</h5>
                            <p class="card-text">endangered</p>
                            <p class="card-text">ill</p>
                            <p class="card-text">newborn</p>
                    ...
                    <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Wildbeast</h5>
                            <p class="card-text">normal</p>
                            <p class="card-text"></p>
                            <p class="card-text"></p>
                    ...
                    <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">bhbjhnikg</h5>
                            <p class="card-text">normal</p>
                            <p class="card-text"></p>
                            <p class="card-text"></p>
                    ...
                    <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Clarisse</h5>
                            <p class="card-text">normal</p>
                            <p class="card-text"></p>
                            <p class="card-text"></p>
